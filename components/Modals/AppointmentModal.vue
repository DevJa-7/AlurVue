  ...
  >
    <b-row>
      ...
      >
        ...
        <b-form @submit="nextStep" method="post" class="spot-form" id="gettingStartedForm" validate="validate">
          <b-form-group
          ...
          <b-form-group
            ...
            label-for="email"
          >
            <b-form-input id="email" name="email" v-model="email" :type="'email'" placeholder="Email address" required></b-form-input>
          </b-form-group>
          <b-form-group
            label="Enter your mobile phone number"
            label-for="phoneNumber"
          >
            <b-form-input id="phoneNumber" name="phoneNumber" v-model="phoneNumber" placeholder="Mobile phone number" required></b-form-input>
          </b-form-group>
          <div class="footer">
            <div class="form-group">
              <p>Continue and select day and time to visit ALUR.</p>
            </div>
            <b-button variant="primary" id="vrFormStep1Toggler" type="submit">Continue</b-button>
          </div>
        </b-form>
      </b-col>
      <b-col
