  ...
  <div>
    ...
    >
      <div class="center-container">
        <div class="text-center modal-title car-2">
          <b-img src="~/assets/images/alur-logo-inverse.svg"/>
          <p class="h1 fw-300 mt-2 subtitle">{{contents.name}}</p>
        </div>
        <component
          :is="slickComp"
          ref="slick"
          ...
          class="slider-for"
        >
          <div v-for="(photo, k) in contents.photos" :key="k">
            <div
              class="image-annotate-canvas position-relative card-panel"
            ...
            >
              ...
              <div class="annotation-container" v-for="(item, key) in photo.annotations" :key="key">
                <span
