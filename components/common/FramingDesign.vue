  ...
  data () {
    return {
      ...
      supportDesigns: [
        ...
        {
          src: require('~/assets/images/bg-product-frame-finish-polished-alum.jpg'),
          text: 'Aluminum is polished and then anodized, providing a smooth, glossy surface.',
          style: {
            top: 255 + 'px',
            left: 170 + 'px'
          },
          handlerSrc: require('~/assets/images/bg_finish_texture_polishedAlum.jpg'),
          handlerText: 'Polished\nAluminum'
        },
        {
