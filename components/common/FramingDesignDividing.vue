...
export default {
  ...
  data () {
    return {
      ...
      supportDesigns: [
        {
          src: require('~/assets/images/bg_product_frameFinish_AA.jpg'),
        ...
        {
          src: require('~/assets/images/bg_product_frameFinish_blackResin.jpg'),
          ...
          handlerSrc: require('~/assets/images/bg_finish_texture_blackResin.jpg'),
        ...
        },
        {
          ...
          handlerSrc: require('~/assets/images/bg_finish_texture_whiteResin.jpg'),
          handlerText: 'White PVDF\nResin'
        },
        {
          src: require('~/assets/images/bg-product-frame-finish-bronze-resin-dividing.jpg'),
          text: 'More durable than powder coatings, PVDF resin-based coating is both functional and decorative. It won’t chalk, pit, chip, age or lose its color and sheen.',
          style: {
            top: 255 + 'px',
            left: 170 + 'px'
          },
          handlerSrc: require('~/assets/images/bg_finish_texture_darkBronze.jpg'),
          handlerText: 'Dark Bronze\nPVDF Resin'
        },
        {
          src: require('~/assets/images/bg-product-frame-finish-bronze-resin-dividing.jpg'),
          text: 'More durable than powder coatings, PVDF resin-based coating is both functional and decorative. It won’t chalk, pit, chip, age or lose its color and sheen.',
  ...
  mounted: function () {
    ...
    if (!this.mode) {
      ...
      this.slickNavOptions.slidesToShow = 4
    }
  }
}
</script>
