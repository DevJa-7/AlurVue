<template>
  <div>
    ...
    >
      ...
      <div class="d-none d-lg-block d-xl-block w-100 desktop-nav">
        <b-nav fill>
          ...
          <b-navbar-nav>
            <b-nav-item href="/dividing-wall/">Dividing Wall</b-nav-item>
    ...
    >
      ...
      <b-navbar-brand
        href="/get-started"
        class="float-right ml-auto chat-icon"
      >
      ...
      >
        ...
        <div class="item">
          <div class="parent">
            <a href="/dividing-wall/">Dividing Wall</a>
          </div>
        </div>
        <div class="item">
          <div class="parent">
      ...
      <b-collapse id="collapse1" class="back-layer" v-b-toggle.collapse1></b-collapse>
    </b-navbar>
  </div>
</template>
