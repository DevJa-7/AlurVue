  ...
  <div>
    ...
    <section class="section section-border-bottom section-vr-spot1 bg-lightgray">
      <b-container class="container-lg text-center">
        ...
        <p>Virtual Reality (VR) technology has advanced rapidly in the past few years and in no other industry is this more <br class="d-none d-lg-block">relevant than in the design industry. Architects and clients can experience a realistic virtual prototype of a space on <br class="d-none d-lg-block">their mobile device before the order is placed and it’s built.</p>
          <b-btn class="btn btn-md btn-primary" 
                data-toggle="modal" 
                @click="modalVisibility = true"
                data-target="#vrModal"  
          ><span>Get Sample Project</span>
          </b-btn>
      </b-container>
    </section>
    ...
    >
      <template slot="modal-content">
        <div
          class="position-relative w-100 vr-modal"
        >
          <b-row class="row-same-height">
            ...
            <b-col cols="12" md="6" class="vertical-center">
              <div class="section-showroom-spot3 show" v-if="vrFormStep1" id="vrFormStep1">
                ...
                <b-form class="spot-form" @submit="handleSubmit" validate="validate">
                  <b-form-group
                    id="fieldset-1"
                    label="Send to my mobile phone number"
                    label-for="vrPhoneNumber"
                  >
                    <b-form-input id="vrPhoneNumber" v-model="vrPhoneNumber" name="vrPhoneNumber" placeholder="Mobile phone number" required></b-form-input>
                  </b-form-group>
                  <b-form-group
                    id="fieldset-1"
                    ...
                    label-for="vrEmail"
                  >
                    <b-form-input id="vrEmail"   name="vrEmail" v-model="vrEmail" :type="'email'" placeholder="Email address" required></b-form-input>
                  </b-form-group>
                  <div class="form-footer">
                    <div class="form-group">
                      <p>*Virtual Reality goggles are required for viewing.</p>
                    </div>
                    <b-button  variant="primary" id="vrFormStep1Toggler" type="submit">SEND DEMO</b-button>
                  </div>
                </b-form>
              </div>
